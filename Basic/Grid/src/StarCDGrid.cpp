...
void StarCDGrid::read_inp(const string& filename)
{
...
void StarCDGrid::read_vrt(const string& filename)
{
    std::ifstream fin(filename);
    double ip, x, y, z;
...
void StarCDGrid::read_cel(const string& filename)
{
    IArray point;
    int blockIndex;
    int id;
...
void StarCDGrid::read_bnd(const string& filename)
{
    std::ifstream fin(filename);
    IArray point;
