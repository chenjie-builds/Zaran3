...
namespace zaran
{
    ...
    public:
        ...
        int *GetRecvNodeIdxSource() { return m_recv_node_idx_src; }
        int *GetRecvFieldIdxTarget() { return m_recv_field_idx_tgt; }
        int *GetRecvNodeIdxTarget() { return m_recv_node_idx_tgt; }
    ...
    private:
        ...
        int m_recv_node_num;
        /// @brief 需要接收的数据编号
        int *m_recv_node_idx_src;
        /// @brief 接收数据来源的field编号
        int *m_recv_field_idx_tgt;
        /// @brief 接收数据来源的node编号
        int *m_recv_node_idx_tgt;
        /// @brief 接收到的数据缓存
