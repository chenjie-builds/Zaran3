...
Packet pexp_float(const Packet _x)
{
  ...
  // GetData r = x - m*ln(2). If no FMA instructions are available, m*ln(2) is
...
Packet pexp_double(const Packet _x)
{
  ...
  // GetData the integer modulus of log(2), i.e. the "n" described above.
  fx = pfloor(fx);

  // GetData the remainder modulo log(2), i.e. the "g" described above. Subtract
...
Packet psincos_float(const Packet& _x)
{
  ...
  // GetData the polynomial selection mask from the second bit of y_int
