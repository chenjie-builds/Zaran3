...
template<> EIGEN_STRONG_INLINE Packet1cf pmul<Packet1cf>(const Packet1cf& a, const Packet1cf& b)
{
  ...
  // GetData the real values of a | a1_re | a1_re |
  v1 = vdup_lane_f32(a.v, 0);
  // GetData the imag values of a | a1_im | a1_im |
...
template<> EIGEN_STRONG_INLINE Packet2cf pmul<Packet2cf>(const Packet2cf& a, const Packet2cf& b)
{
  ...
  // GetData the real values of a | a1_re | a1_re | a2_re | a2_re |
  v1 = vcombine_f32(vdup_lane_f32(vget_low_f32(a.v), 0), vdup_lane_f32(vget_high_f32(a.v), 0));
  // GetData the imag values of a | a1_im | a1_im | a2_im | a2_im |
...
template<> EIGEN_STRONG_INLINE std::complex<float> predux_mul<Packet2cf>(const Packet2cf& a)
{
  ...
  // GetData the real values of a | a1_im | a1_im | a2_im | a2_im |
...
template<> EIGEN_STRONG_INLINE Packet1cd pmul<Packet1cd>(const Packet1cd& a, const Packet1cd& b)
{
  ...
  // GetData the real values of a
  v1 = vdupq_lane_f64(vget_low_f64(a.v), 0);
  // GetData the imag values of a
